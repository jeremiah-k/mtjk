...
from . import connection_status_pb2 as meshtastic_dot_protobuf_dot_connection__status__pb2
from . import device_ui_pb2 as meshtastic_dot_protobuf_dot_device__ui__pb2
from . import mesh_pb2 as meshtastic_dot_protobuf_dot_mesh__pb2
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ADMINMESSAGE_INPUTEVENT'].fields_by_name['event_code']._loaded_options = None
  _globals['_ADMINMESSAGE_INPUTEVENT'].fields_by_name['event_code']._serialized_options = b'\222?\0028\010'
  _globals['_ADMINMESSAGE_INPUTEVENT'].fields_by_name['kb_char']._loaded_options = None
  _globals['_ADMINMESSAGE_INPUTEVENT'].fields_by_name['kb_char']._serialized_options = b'\222?\0028\010'
  _globals['_ADMINMESSAGE_INPUTEVENT'].fields_by_name['touch_x']._loaded_options = None
  _globals['_ADMINMESSAGE_INPUTEVENT'].fields_by_name['touch_x']._serialized_options = b'\222?\0028\020'
  _globals['_ADMINMESSAGE_INPUTEVENT'].fields_by_name['touch_y']._loaded_options = None
  _globals['_ADMINMESSAGE_INPUTEVENT'].fields_by_name['touch_y']._serialized_options = b'\222?\0028\020'
  _globals['_ADMINMESSAGE_OTAEVENT'].fields_by_name['ota_hash']._loaded_options = None
  _globals['_ADMINMESSAGE_OTAEVENT'].fields_by_name['ota_hash']._serialized_options = b'\222?\002\010 '
  _globals['_ADMINMESSAGE'].fields_by_name['session_passkey']._loaded_options = None
  _globals['_ADMINMESSAGE'].fields_by_name['session_passkey']._serialized_options = b'\222?\002\010\010'
  _globals['_ADMINMESSAGE'].fields_by_name['get_canned_message_module_messages_response']._loaded_options = None
  _globals['_ADMINMESSAGE'].fields_by_name['get_canned_message_module_messages_response']._serialized_options = b'\222?\003\010\311\001'
  _globals['_ADMINMESSAGE'].fields_by_name['get_ringtone_response']._loaded_options = None
  _globals['_ADMINMESSAGE'].fields_by_name['get_ringtone_response']._serialized_options = b'\222?\003\010\347\001'
  _globals['_ADMINMESSAGE'].fields_by_name['delete_file_request']._loaded_options = None
  _globals['_ADMINMESSAGE'].fields_by_name['delete_file_request']._serialized_options = b'\222?\003\010\311\001'
  _globals['_ADMINMESSAGE'].fields_by_name['set_canned_message_module_messages']._loaded_options = None
  _globals['_ADMINMESSAGE'].fields_by_name['set_canned_message_module_messages']._serialized_options = b'\222?\003\010\311\001'
  _globals['_ADMINMESSAGE'].fields_by_name['set_ringtone_message']._loaded_options = None
  _globals['_ADMINMESSAGE'].fields_by_name['set_ringtone_message']._serialized_options = b'\222?\003\010\347\001'
  ...
  _globals['_LOCKDOWNAUTH'].fields_by_name['passphrase']._loaded_options = None
  _globals['_LOCKDOWNAUTH'].fields_by_name['passphrase']._serialized_options = b'\222?\002\010 '
  _globals['_HAMPARAMETERS'].fields_by_name['call_sign']._loaded_options = None
  _globals['_HAMPARAMETERS'].fields_by_name['call_sign']._serialized_options = b'\222?\002\010\010'
  _globals['_HAMPARAMETERS'].fields_by_name['short_name']._loaded_options = None
  _globals['_HAMPARAMETERS'].fields_by_name['short_name']._serialized_options = b'\222?\002\010\005'
  _globals['_HAMPARAMETERS'].fields_by_name['long_name']._loaded_options = None
  _globals['_HAMPARAMETERS'].fields_by_name['long_name']._serialized_options = b'\222?\002\010\017'
  _globals['_NODEREMOTEHARDWAREPINSRESPONSE'].fields_by_name['node_remote_hardware_pins']._loaded_options = None
  _globals['_NODEREMOTEHARDWAREPINSRESPONSE'].fields_by_name['node_remote_hardware_pins']._serialized_options = b'\222?\002\020\020'
  _globals['_OTAMODE']._serialized_start=6070
  _globals['_OTAMODE']._serialized_end=6125
  ...
  _globals['_LOCKDOWNAUTH']._serialized_start=4142
  _globals['_LOCKDOWNAUTH']._serialized_end=4299
  _globals['_HAMPARAMETERS']._serialized_start=4302
  _globals['_HAMPARAMETERS']._serialized_end=4433
  _globals['_NODEREMOTEHARDWAREPINSRESPONSE']._serialized_start=4435
  _globals['_NODEREMOTEHARDWAREPINSRESPONSE']._serialized_end=4553
  _globals['_SHAREDCONTACT']._serialized_start=4555
  _globals['_SHAREDCONTACT']._serialized_end=4679
  _globals['_KEYVERIFICATIONADMIN']._serialized_start=4682
  _globals['_KEYVERIFICATIONADMIN']._serialized_end=4975
  _globals['_KEYVERIFICATIONADMIN_MESSAGETYPE']._serialized_start=4852
  _globals['_KEYVERIFICATIONADMIN_MESSAGETYPE']._serialized_end=4955
  _globals['_SENSORCONFIG']._serialized_start=4978
  _globals['_SENSORCONFIG']._serialized_end=5220
  _globals['_SCD4X_CONFIG']._serialized_start=5223
  _globals['_SCD4X_CONFIG']._serialized_end=5577
  _globals['_SEN5X_CONFIG']._serialized_start=5579
  _globals['_SEN5X_CONFIG']._serialized_end=5697
  _globals['_SCD30_CONFIG']._serialized_start=5700
  _globals['_SCD30_CONFIG']._serialized_end=6008
  _globals['_SHTXX_CONFIG']._serialized_start=6010
  _globals['_SHTXX_CONFIG']._serialized_end=6068
