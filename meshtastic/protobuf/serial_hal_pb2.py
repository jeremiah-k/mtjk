...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'meshtastic/protobuf/serial_hal.proto'
)
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_SERIALHALCOMMAND'].fields_by_name['data']._loaded_options = None
  _globals['_SERIALHALCOMMAND'].fields_by_name['data']._serialized_options = b'\222?\003\010\200\004'
  _globals['_SERIALHALRESPONSE'].fields_by_name['data']._loaded_options = None
  _globals['_SERIALHALRESPONSE'].fields_by_name['data']._serialized_options = b'\222?\003\010\200\004'
  _globals['_SERIALHALRESPONSE'].fields_by_name['error']._loaded_options = None
  _globals['_SERIALHALRESPONSE'].fields_by_name['error']._serialized_options = b'\222?\002\010P'
