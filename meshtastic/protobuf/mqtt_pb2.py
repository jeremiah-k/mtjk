...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_MAPREPORT'].fields_by_name['long_name']._loaded_options = None
  _globals['_MAPREPORT'].fields_by_name['long_name']._serialized_options = b'\222?\002\010\031'
  _globals['_MAPREPORT'].fields_by_name['short_name']._loaded_options = None
  _globals['_MAPREPORT'].fields_by_name['short_name']._serialized_options = b'\222?\002\010\005'
  _globals['_MAPREPORT'].fields_by_name['firmware_version']._loaded_options = None
  _globals['_MAPREPORT'].fields_by_name['firmware_version']._serialized_options = b'\222?\002\010\022'
  _globals['_MAPREPORT'].fields_by_name['num_online_local_nodes']._loaded_options = None
  _globals['_MAPREPORT'].fields_by_name['num_online_local_nodes']._serialized_options = b'\222?\0028\020'
