...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_WIFICONNECTIONSTATUS'].fields_by_name['ssid']._loaded_options = None
  _globals['_WIFICONNECTIONSTATUS'].fields_by_name['ssid']._serialized_options = b'\222?\002\010!'
