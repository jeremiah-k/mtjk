...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DEVICEPROFILE'].fields_by_name['long_name']._loaded_options = None
  _globals['_DEVICEPROFILE'].fields_by_name['long_name']._serialized_options = b'\222?\002\010\031'
  _globals['_DEVICEPROFILE'].fields_by_name['short_name']._loaded_options = None
  _globals['_DEVICEPROFILE'].fields_by_name['short_name']._serialized_options = b'\222?\002\010\005'
  _globals['_DEVICEPROFILE'].fields_by_name['ringtone']._loaded_options = None
  _globals['_DEVICEPROFILE'].fields_by_name['ringtone']._serialized_options = b'\222?\003\010\347\001'
  _globals['_DEVICEPROFILE'].fields_by_name['canned_messages']._loaded_options = None
  _globals['_DEVICEPROFILE'].fields_by_name['canned_messages']._serialized_options = b'\222?\003\010\311\001'
