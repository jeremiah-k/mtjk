...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_FILETRANSFER'].fields_by_name['filepath']._loaded_options = None
  _globals['_FILETRANSFER'].fields_by_name['filepath']._serialized_options = b'\222?\003\010\200\002'
  _globals['_FILETRANSFER'].fields_by_name['filedata']._loaded_options = None
  _globals['_FILETRANSFER'].fields_by_name['filedata']._serialized_options = b'\222?\003\010\200 '
  _globals['_FILETRANSFER'].fields_by_name['message']._loaded_options = None
  _globals['_FILETRANSFER'].fields_by_name['message']._serialized_options = b'\222?\003\010\377\001'
  _globals['_DIRECTORYLISTING'].fields_by_name['directory']._loaded_options = None
  _globals['_DIRECTORYLISTING'].fields_by_name['directory']._serialized_options = b'\222?\003\010\200\002'
  _globals['_DIRECTORYLISTING'].fields_by_name['filenames']._loaded_options = None
  _globals['_DIRECTORYLISTING'].fields_by_name['filenames']._serialized_options = b'\222?\005\020\020p\377\001'
  _globals['_DIRECTORYLISTING'].fields_by_name['message']._loaded_options = None
  _globals['_DIRECTORYLISTING'].fields_by_name['message']._serialized_options = b'\222?\003\010\377\001'
  _globals['_I2CTRANSACTION'].fields_by_name['write_data']._loaded_options = None
  _globals['_I2CTRANSACTION'].fields_by_name['write_data']._serialized_options = b'\222?\003\010\200\002'
  _globals['_I2CRESULT'].fields_by_name['read_data']._loaded_options = None
  _globals['_I2CRESULT'].fields_by_name['read_data']._serialized_options = b'\222?\003\010\200\002'
  _globals['_INTERDEVICEMESSAGE'].fields_by_name['nmea']._loaded_options = None
  _globals['_INTERDEVICEMESSAGE'].fields_by_name['nmea']._serialized_options = b'\222?\003\010\200\010'
  _globals['_INTERDEVICEMESSAGE'].fields_by_name['beep']._loaded_options = None
  _globals['_INTERDEVICEMESSAGE'].fields_by_name['beep']._serialized_options = b'\222?\0028\020'
  _globals['_INTERDEVICEMESSAGE'].fields_by_name['i2c_scan_result']._loaded_options = None
  _globals['_INTERDEVICEMESSAGE'].fields_by_name['i2c_scan_result']._serialized_options = b'\222?\003\010\200\001'
