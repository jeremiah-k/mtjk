...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DEVICEUICONFIG'].fields_by_name['screen_brightness']._loaded_options = None
  _globals['_DEVICEUICONFIG'].fields_by_name['screen_brightness']._serialized_options = b'\222?\0028\010'
  _globals['_DEVICEUICONFIG'].fields_by_name['screen_timeout']._loaded_options = None
  _globals['_DEVICEUICONFIG'].fields_by_name['screen_timeout']._serialized_options = b'\222?\0028\020'
  _globals['_DEVICEUICONFIG'].fields_by_name['ring_tone_id']._loaded_options = None
  _globals['_DEVICEUICONFIG'].fields_by_name['ring_tone_id']._serialized_options = b'\222?\0028\010'
  _globals['_DEVICEUICONFIG'].fields_by_name['calibration_data']._loaded_options = None
  _globals['_DEVICEUICONFIG'].fields_by_name['calibration_data']._serialized_options = b'\222?\002\010\020'
  _globals['_DEVICEUICONFIG'].fields_by_name['compass_mode']._loaded_options = None
  _globals['_DEVICEUICONFIG'].fields_by_name['compass_mode']._serialized_options = b'\222?\0028\010'
  _globals['_DEVICEUICONFIG'].fields_by_name['gps_format']._loaded_options = None
  _globals['_DEVICEUICONFIG'].fields_by_name['gps_format']._serialized_options = b'\222?\0028\010'
  _globals['_NODEFILTER'].fields_by_name['hops_away']._loaded_options = None
  _globals['_NODEFILTER'].fields_by_name['hops_away']._serialized_options = b'\222?\0028\010'
  _globals['_NODEFILTER'].fields_by_name['node_name']._loaded_options = None
  _globals['_NODEFILTER'].fields_by_name['node_name']._serialized_options = b'\222?\002\010\020'
  _globals['_NODEFILTER'].fields_by_name['channel']._loaded_options = None
  _globals['_NODEFILTER'].fields_by_name['channel']._serialized_options = b'\222?\0028\010'
  _globals['_NODEHIGHLIGHT'].fields_by_name['node_name']._loaded_options = None
  _globals['_NODEHIGHLIGHT'].fields_by_name['node_name']._serialized_options = b'\222?\002\010\020'
  _globals['_GEOPOINT'].fields_by_name['zoom']._loaded_options = None
  _globals['_GEOPOINT'].fields_by_name['zoom']._serialized_options = b'\222?\0028\010'
  _globals['_MAP'].fields_by_name['style']._loaded_options = None
  ...
  _globals['_LANGUAGE']._serialized_end=1853
